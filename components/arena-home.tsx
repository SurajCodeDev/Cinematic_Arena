      ...
      <header className="relative z-20 border-b border-border/70 bg-background/80 backdrop-blur-xl">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="hidden items-center gap-2 border border-border bg-card/50 px-4 py-2.5 font-mono text-[10px] uppercase tracking-[0.15em] text-muted-foreground transition hover:border-primary/50 hover:text-primary sm:flex" onClick={() => notify('Sign in flow ready for connection')}><Users className="size-4" /> Sign in</button>
      ...
      <section id="top" className="relative isolate min-h-[600px] overflow-hidden border-b border-border lg:min-h-[650px]">
        ...
        <div className="mx-auto flex min-h-[600px] max-w-7xl items-end px-5 pb-16 pt-24 lg:min-h-[650px] lg:items-center lg:px-8 lg:pb-12">
          <div className="max-w-2xl">
            ...
            <div className="mt-9 flex flex-wrap gap-3"><button className="group flex items-center gap-3 bg-primary px-6 py-3.5 font-mono text-[11px] font-bold uppercase tracking-[0.14em] text-primary-foreground transition hover:bg-primary/90" onClick={() => document.getElementById('tournaments')?.scrollIntoView({ behavior: 'smooth' })}>Browse tournaments <ArrowRight className="size-4 transition-transform group-hover:translate-x-1" /></button><button className="flex items-center gap-3 border border-foreground/20 bg-background/30 px-6 py-3.5 font-mono text-[11px] uppercase tracking-[0.14em] text-foreground backdrop-blur-sm transition hover:border-primary/50 hover:text-primary" onClick={() => notify('Player registration opens with secure email sign in')}>Create your squad <Users className="size-4" /></button></div>
