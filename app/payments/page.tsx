...
export default async function PaymentsPage({ searchParams }: { searchParams: Promise<{ amount?: string; registrationId?: string }> }) {
  const { amount = '99', registrationId } = await searchParams
